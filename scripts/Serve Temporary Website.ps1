...
#
#   Run:   .\scripts\"Serve Temporary Website.ps1"     (from the repo root)
...
# docs is one level up from this script's new home in scripts\
Set-Location (Join-Path (Split-Path $PSScriptRoot) "docs")
